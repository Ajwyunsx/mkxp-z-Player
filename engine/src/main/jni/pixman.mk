...
ifeq ($(TARGET_ARCH_ABI), armeabi-v7a)
	# The upstream ARMv7 assembly macros are not accepted by the NDK r25
	# clang assembler. Use pixman's portable implementation on armv7 for now.
else ifeq ($(TARGET_ARCH_ABI), arm64-v8a)
	# The upstream AArch64 assembly is not accepted by the NDK r25 clang
	# assembler. Use pixman's portable implementation on arm64 for now.
